...
Configure::read("gestion_commercial_standard") == '1' || Configure::read("parc_master") == '1' ||
Configure::read("logistia") == '1'
) { ?>
    <?php if (!$hidden_information['Parameter']['totaux_dashbord']) { ?>
            ...
            if ($resultCommercial) { ?>
                <div class="col-lg-3">
                    <div class="panel panel-color panel-danger">
                        <div class="panel-heading panel-green panel-blue-dark">
        ...
        if(Configure::read("gestion_commercial") == '1') {
            ...
            if ($resultFinance) { ?>
                <div class="col-lg-4">
                    <div class="panel panel-color panel-danger panel-blue-dark">
                        <div class="panel-heading panel-green">
...
<div class="col-lg-10">
    <div class="inside-ds">
        <div class="panel panel-color panel-info">
            <div class="panel-heading panel-green panel-blue">
                ...
                <ul class="quick-links">
                    <li>
                        <div>
                            ...
                            <?php $client_i2b = 0 ; if ($client_i2b == 1) { ?>
                            ...
                            <?php } else {
                               if(Configure::read("djazfleet")==1) {
                                $link_djazfleet= Configure::read('link_djazfleet');

                                $url = 'https://djazfleet-dz.com/api/login';
                                $data = array('email' => 'parcmaster@parcmaster.com', 'password' => '1234');
                                ...
                                //$result = json_decode($result);
                                      ...
                                      //  header('Location:https://djazfleet.com/objects');



                                ?>

                                <form method='POST' target='_blanck' action="https://djazfleet-dz.com/authentication/store">
                                    <?php
                                  /*  $email = $this->Session->read('Auth.User.email');
                                    $password = $this->Session->read('djazfleet');*/

                                    $email =  'parcmaster@parcmaster.com' ;
                                    $password = 'bil2020';
                                    ...
                                    <input type="hidden" name="password" value="<?php echo $password; ?>">
                                        ...
                                        <button id="submitDjazfleet"
                                            ...
                                            <i class='fa fa-caret-right'
                                               style="font-size: 10px;width: 10px;padding-top: 4px;font-weight: normal;color: #f9c851;"></i>
                                            <span><?= __("Connect to geolocalisation") ?></span>
                                        </button>
                                    <?php
...
<script type="text/javascript">
    $(document ).ready(function(){
        ...
        $('#batch-reception').click(function () {
