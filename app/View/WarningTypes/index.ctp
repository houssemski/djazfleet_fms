...
<h4 class="page-title"> <?= __('Warning types'); ?></h4>
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("warningTypes/deleteTypes/");',
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('WarningTypes', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                    ...
                    <div class="dataTables_length m-r-15" id="datatable-editable_length" style="display: inline-block;">
                        <label>&nbsp; <?= __('Order : ') ?>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="selectOrder"
                                    id="selectOrder" onchange="selectOrderChanged('warningTypes/index','DESC');">
                                <option
                                    value="1" <?php if ($order == 1) echo 'selected="selected"' ?>> <?= __('Code') ?></option>
                                <option
                                    value="2" <?php if ($order == 2) echo 'selected="selected"' ?>><?= __('Name') ?></option>
                                <option
                                    value="3" <?php if ($order == 3) echo 'selected="selected"' ?>><?= __('Id') ?></option>

                            </select>
                        </label>
                        <span id="asc_desc" >
                        <i class="fa fa-sort-asc" id="asc" onclick="selectOrderChanged('warningTypes/index', 'ASC');"></i>
                        <i class="fa fa-sort-desc" id="desc" onclick="selectOrderChanged('warningTypes/index','DESC');"></i>
                        </span>
                    </div>
                    <div class="dataTables_length" id="datatable-editable_length" style="display: inline-block;">
                        <label>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="slctlimit"
                                    id="slctlimit" onchange="slctlimitChanged('marchandiseTypes/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody id="listeDiv">
                    <?php foreach ($warningTypes as $warningType): ?>
                        <tr id="row<?= $warningType['WarningType']['id'] ?>">
                            <td>

                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $warningType['WarningType']['id'] ?>>
                            </td>
                            <td><?php echo h($warningType['WarningType']['code']); ?>&nbsp;</td>
                            <td><?php echo h($warningType['WarningType']['name']); ?>&nbsp;</td>

                            <td><?php echo h($this->Time->format($warningType['WarningType']['created'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td><?php echo h($this->Time->format($warningType['WarningType']['modified'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td class="actions">
                                <div class="btn-group ">
                                    ...
                                    <ul class="dropdown-menu" style="min-width: 70px;">
                                        ...
                                        <li>
                                            <?= $this->Html->link(
                                                ...
                                                array('action' => 'View', $warningType['WarningType']['id']),
                                        ...
                                        <li>
                                            <?= $this->Html->link(
                                                ...
                                                array('action' => 'Edit', $warningType['WarningType']['id']),
                                        ...
                                        <li>
                                            ...
                                            echo $this->Form->postLink(
                                                ...
                                                array('action' => 'delete', $warningType['WarningType']['id']),
                                                array('escape' => false, 'class' => 'btn btn-danger'),
                                                __('Are you sure you want to delete %s?', $warningType['WarningType']['name'])); ?>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div id="pagination" class="pull-right">
                    <?php
                    if ($this->params['paging']['WarningType']['pageCount'] > 1) {
                        ?>
                        <p>
                            <?php
