...
//echo '<div class="col-sm-3 browsecar"><a  onclick="upload_picture(\''.$array_fichier.'\');" ><img class = "picture_dir" src="../attachments/picturesaffectation/'.$dir.'/'. $array_fichier .'"/></a><a  onclick="upload_picture(\''.$array_fichier.'\');" ><h3 class="titre_picture"> ' . $array_fichier .'</h3></a></div>';
...
echo $this->Html->image('/attachments/picturesaffectation/'.$dir.'/'. $array_fichier,  array('class' => 'picture_dir' ));
}else  { if ($ext=='pdf') {
...
<script type="text/javascript">     $(document).ready(function() {      });
 ...
 var dir1 = <?php echo json_encode($id_input); ?>
        ...
        jQuery("#"+''+dir+''+"").dialog('close');   //close containing dialog         
            ...
            jQuery("#"+''+dir1+''+"").load("<?php echo $this->Html->url('/customercars/uploadPicture/')?>" + name+ '/'+ dir1);
       }
