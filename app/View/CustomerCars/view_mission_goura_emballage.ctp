    ...
    <body>
            ...
            <table>
                <tr>
					...
					<td class="info_fiscal">
							...
							<span><strong>Id Fiscal :</strong><?= $company['Company']['cb']?></span><br>
							<span><strong>NIF :</strong><?= $company['Company']['nif']?></span>
                    </td>
                </tr>
            </table>
            <?php }?>
        ...
        <div class="box-body">
			...
			<div class='all_date'>
				...
				<td style='width:250px; padding:30px 0; border: 1px solid #000;'><?php  echo sprintf("%02d", $k).'/'.$month.'/'.$year; $k++;?></td>
