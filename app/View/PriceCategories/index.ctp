...
<h4 class="page-title"> <?= __('Tariffs'); ?></h4>
<div class="box-body">
    <div class="row">
        <!-- BASIC WIZARD -->
        <div class="col-lg-12">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("priceCategories/deleteCategories/");',
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('PriceCategories', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                    ...
                    <div>
                        <label>
                            ...
                            <select name="slctlimit" id="slctlimit"
                                    onchange="slctlimitChanged('priceCategories/index');">
                ...
                <div id="pagination" class="pull-right">
                    <?php if ($this->params['paging']['PriceCategory']['pageCount'] > 1) { ?>
                        <p>
                            <?php
