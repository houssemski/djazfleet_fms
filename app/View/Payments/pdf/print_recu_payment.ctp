...
?>
    ...
    <div class="box-body">
        <div class="title"><?php echo __('Recu de paiement') ?></div>
    ...
    <div class="box-body2">
        <div class="total">
            <div class="left-ct">
                <span class="left"><strong><?php echo  __('Date: '); ?></strong></span> <span class="left"> <?php echo h($this->Time->format($payment['Payment']['receipt_date'], '%d-%m-%Y')); ?></span><br>
                <span class="left"><strong><?php echo  __('Reçu de : '); ?></strong></span> <span class="left"><?php echo  $payment['Supplier']['name'] ?></span><br>
                <span class="left"><strong><?php echo  __('Montant: '); ?></strong></span> <span class="left"> <?= number_format($payment['Payment']['amount'], 2, ",", $separatorAmount).' '. $this->Session->read("currency");?></span><br>
                <span class="left"><strong><?php echo  __('Type de paiement: '); ?></strong></span> <span class="left">
                    <?php switch($payment['Payment']['payment_type']){
                        case 1:
                            echo __('Species');
                            break;
                        case 2:
