        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            events: [
                ...
                foreach($sheetRideDetailRides as $sheetRideDetailRide) { ?>
                {
                    ...
                    id : <?php echo $sheetRideDetailRide['SheetRide']['id'] ?>,
                    title: '<?php echo $sheetRideDetailRide['Car']['code'].' '.$sheetRideDetailRide['Carmodel']['name'].' '.$sheetRideDetailRide['Customer']['first_name'].' ' .$sheetRideDetailRide['Customer']['last_name'].' '.$sheetRideDetailRide['DepartureDestination']['name'].' '.$sheetRideDetailRide['ArrivalDestination']['name']?>',
                    <?php
                    if(!empty($sheetRideDetailRide['SheetRideDetailRides']['real_start_date'])){
                    $dateStart = date_parse($sheetRideDetailRide['SheetRideDetailRides']['real_start_date']);
                    }else {
                    $dateStart = date_parse($sheetRideDetailRide['SheetRideDetailRides']['planned_start_date']);
                    }
                    ...
                    $dateEnd = date_parse($sheetRideDetailRide['SheetRideDetailRides']['real_end_date']);
                    }else {
                    $dateEnd = date_parse($sheetRideDetailRide['SheetRideDetailRides']['planned_end_date']);
                    }
                    $dayEnd = $dateEnd['day'];
