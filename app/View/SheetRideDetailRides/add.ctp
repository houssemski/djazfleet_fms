...
<h4 class="page-title"> <?= __('Add mission'); ?></h4>
<style>
    .filters {
        clear: both;
        width: 1050px;
...
<div class="box">
    <div class="edit form card-box p-b-0">
        <?php
        $i = 1;
        echo $this->Form->create('SheetRideDetailRides', array('enctype' => 'multipart/form-data', 'onsubmit' => 'javascript:disable();')); ?>
