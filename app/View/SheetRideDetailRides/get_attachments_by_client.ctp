    ...
    foreach ($attachmentTypes as $attachmentType) {
        ...
        if (isset($attachments[$j]) &&
            ...
            <div id=<?php echo $attachmentType['AttachmentType']['id'] ?>-file class="col-md-12">
                ...
                <?php
                echo "<div class='form-group input-button2 input-file'>" . $this->Form->input('SheetRideDetailRides.Attachment.' . $attachmentType['AttachmentType']['id'] . '.attachment_number', array(
                        'label' => __('Number') . ' ' . $attachmentType['AttachmentType']['name'],
                        'class' => 'form-control ',
                        'value' => $attachments[$j]['Attachment']['attachment_number'],
                        'empty' => ''
                    )) . "</div>";
                echo "<div  style='Display:none;'>" . $this->Form->input('SheetRideDetailRides.Attachment.' . $attachmentType['AttachmentType']['id'], array(
                ...
                echo "<div class='input-button4 m-t-5 input-file' >" . $this->Form->input('SheetRideDetailRides.Attachment.file' . $attachmentType['AttachmentType']['id'], array(
            ...
            <div id=<?php echo $attachmentType['AttachmentType']['id'] ?>-file class="col-md-12">
                ...
                echo "<div class='form-group input-button2 input-file'>" . $this->Form->input('SheetRideDetailRides.Attachment.' . $attachmentType['AttachmentType']['id'], array(
                        'label' => $attachmentType['AttachmentType']['name'],
