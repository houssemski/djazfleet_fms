...
<div class="box-body">
    <div class="date" ><span class='ref' style="text-align:left;">
                    <strong>N&deg; : <?= $sheetRide['SheetRide']['reference'] ?></strong>
                </span>
        <span style="text-align:right;"><strong>Le : </strong><?= date("d-m-Y") ?></span>
    </div>
    ...
    <div class="customer">
        <table>
            <tr >
                <td style="padding-top: 30px"><strong>&nbsp;Nom  et pr&eacute;nom :</strong> &nbsp;<?= $sheetRide['Customer']['first_name'].' '.$sheetRide['Customer']['last_name']?> </td>
                <td></td>
                <td rowspan=3>
                    <?php if(!empty($sheetRide['Customer']['image'])) {?>
                        <img style="padding-left: 50px" src="<?= WWW_ROOT ?>/img/customers/<?= $sheetRide['Customer']['image'] ?>" width="100px" height="140px">
                    <?php }?>
                </td>
            </tr>
            <tr>
                <td><strong>&nbsp;Profession :</strong> &nbsp;<?= $sheetRide['CustomerCategory']['name']?> </td>
                <td><strong>&nbsp;Tel : </strong>&nbsp;<?= $sheetRide['Customer']['tel']?></td>
            ...
            <tr>
                <td><strong>&nbsp;Moyen de transport : </strong>&nbsp;<?= $sheetRide['Carmodel']['name'] ?> </td>
                <td><strong>&nbsp;Matricule :</strong> &nbsp;<?= $sheetRide['Car']['immatr_def'] ?></td>
