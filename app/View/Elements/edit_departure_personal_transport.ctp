<div class="filters" id='filters'>
    ...
    <?php  echo "<div>" . $this->Form->input('calcul_maps', array(
            'label' => '',
            'type' => 'hidden',
            'class' => 'form-control',
            'id' => 'calcul_maps',
                                                ...
                                                switch ($consumption['Consumption']['type_consumption_used']) {
                                                    ...
                                                    case ConsumptionTypesEnum::species :
                                                        ...
                                                        <div id='consump_compte<?php echo $i ?>'>
                                                            ...
                                                            <?php   echo "<div   class='select-inline consumption' id='reference_compte_div$i '>" . $this->Form->input('Consumption.' . $i . '.compte_id', array(
                                                                    'label' => __('Comptes'),
                                                                    'type' => 'select',
                                                                    'options' => $comptes,
