...
<head>
    ...
    <style type="text/css">
        ...
        #informations table .company .company_name{
            display: block;
            font-size: 25px;
            text-align: left;
        }
...
<div class="box-body">
    ...
    <table class='bon table-bordered tab_' >
        ...
        <tr>
            ...
            <th><strong><?php echo __('Adress'); ?></strong></th>
            <th><strong><?php echo __('Category'); ?></strong></th>
        ...
        <?php foreach ($suppliers as $supplier){?>
            <tr>
                ...
                <td><?php echo h($supplier['Category']['name']); ?>&nbsp;</td>
                <td><?php echo h($supplier['Supplier']['balance']); ?>&nbsp;</td>
            </tr>
        <?php }
        ?>
        </tbody>
