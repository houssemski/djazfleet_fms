...
<?php
$this->request->data['ComplaintResponse']['response_date'] = $this->Time->format($this->request->data['ComplaintResponse']['response_date'], '%d-%m-%Y');
?><h4 class="page-title"> <?=__('Edit response'); ?></h4>
    <div class="box">
