...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        jQuery('#product_type').change(function (event) {
            event.preventDefault();
            jQuery('#disposition-div').load('<?php echo $this->Html->url('/products/getFieldsByProductType/')?>' + jQuery('#product_type').val(), function () {
                jQuery('#ProductNbHoursRequired1').change(function () {
                    jQuery("#nb-hours-div").css("display", "block");

                    jQuery('#ProductNbHours').attr('required', 'required');
                    jQuery('#ProductNbHours').parent().addClass('required');
                });

                jQuery('#ProductNbHoursRequired2').change(function () {
                    jQuery("#nb-hours-div").css("display", "none");
                    jQuery('#ProductNbHours').removeAttr('required');
                    jQuery('#ProductNbHours').parent().removeClass('required');
                });
