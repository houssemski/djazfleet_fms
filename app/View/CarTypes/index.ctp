<h4 class="page-title"> <?= __('Car types'); ?></h4>
<div class="box-body">
    <div class="row">
        <!-- BASIC WIZARD -->
        <div class="col-lg-12">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("carTypes/deletecartypes/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected car type ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('CarTypes', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('category', __('Categories')); ?></th>
                        <th><?php echo $this->Paginator->sort('average_speed', __('Average speed') . ' ' . _('(Km/h)')); ?></th>
                ...
                <div id="pagination" class="pull-right">
                    <?php if ($this->params['paging']['CarTypeCarCategory']['pageCount'] > 1) { ?>
                        <p>
                            <?php
