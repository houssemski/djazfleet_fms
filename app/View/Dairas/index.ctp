<h4 class="page-title"> <?= __('Provinces'); ?></h4>
<div class="box-body">
    <div class="row">
        <!-- BASIC WIZARD -->
        <div class="col-lg-12">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                                ...
                                <ul class="dropdown-menu imp" role="menu">
                                    <li>
                                        <div class="timeline-body">
                                            <?php echo $this->Html->link(__('Download file model'), '/attachments/import_xls/dairas.csv', array('class' => 'titre')); ?>
                                            <br/>

                                            <form id='DairaImportForm' action='dairas/import' method='post'
                                                  enctype='multipart/form-data' novalidate='novalidate'>
                                                <?php echo "<div class='form-group'>" . $this->Form->input('Daira.file_csv', array(
                                                        'label' => __('File .csv'),
                                                        'class' => '',
                                                        'type' => 'file',
                                                        //'id' =>'file_cars',
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("dairas/deleteDairas/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected daira ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Dairas', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <div class="bloc-limit btn-group pull-left">
                    <div>
                        <label>
                            ...
                            ?>
                            <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('dairas/index');">
                        ...
                        <tr id="row<?= $daira['Daira']['id'] ?>">
                            <td>
                                ...
                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $daira['Daira']['id'] ?>>
                            </td>
                            <td><?php echo h($daira['Daira']['code']); ?>&nbsp;</td>
                            <td><?php echo h($daira['Daira']['name']); ?>&nbsp;</td>
                            <td><?php echo h($daira['Wilaya']['name']); ?>&nbsp;</td>
                            <td><?php echo h($this->Time->format($daira['Daira']['created'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td><?php echo h($this->Time->format($daira['Daira']['modified'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td class="actions">
                                <?= $this->Html->link(
                ...
                <div id="pagination" class="pull-right">
                    <?php if ($this->params['paging']['Daira']['pageCount'] > 1) { ?>
                        <p>
                            <?php
