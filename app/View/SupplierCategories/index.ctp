<?php if ($this->params['pass']['0'] == 0) { ?>
    <h4 class="page-title"> <?= __('Suppliers categories'); ?></h4>

<?php } else { ?>
    <h4 class="page-title"> <?= __('Clients categories'); ?></h4>
...
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("supplierCategories/deletecategories/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected Supplier category ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('SupplierCategories', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                    ...
                    <div>
                        <label>
                            ...
                            <select name="slctlimit" id="slctlimit"
                                    onchange="slctlimitChanged('supplierCategories/index');">
