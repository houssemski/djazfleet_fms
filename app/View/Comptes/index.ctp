...
<h4 class="page-title"> <?= __('Comptes'); ?></h4>
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class=" fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("Comptes/deleteComptes/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected comptes ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Comptes', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <div class="bloc-limit btn-group pull-left">
                    <div>
                        <label>
                            ...
                            ?>
                            <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('comptes/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <?php foreach ($comptes as $compte): ?>
                        <tr id="row<?= $compte['Compte']['id'] ?>">
                            ...
                            <td><?php  if($compte['Compte']['type_id']==1){ echo __('Bank');}else { echo __('Species'); }; ?>&nbsp;</td>
                            <td><?php echo h($compte['Compte']['rib']); ?>&nbsp;</td>
                            <td><?php echo h($compte['Compte']['agency']); ?>&nbsp;</td>
                            ...
                            <td class="actions">
                                <div class="btn-group ">
                                    ...
                                    <ul class="dropdown-menu" style="min-width: 70px;">
                                        ...
                                        <li class='edit-link' title="<?= __('Recalculate balance') ?>">
                                            <?= $this->Html->link(
                                                '<i class="fa fa-money" ></i>',
                                                array('action' => 'recalculateBalance', $compte['Compte']['id']),
