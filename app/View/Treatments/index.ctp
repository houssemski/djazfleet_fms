<h4 class="page-title"> <?= __('Treatments'); ?></h4>
<?php
$this->start('css');
...
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("departments/deleteTreatments/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected treatment ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Treatments', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <?php foreach ($treatments as $treatment): ?>
                        <tr id="row<?= $treatment['Treatment']['id'] ?>">
                            <td>

                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $treatment['Treatment']['id'] ?>>
                            </td>

                            <td><?php echo h($treatment['Treatment']['name']); ?>&nbsp;</td>
                            <td><?php echo h($this->Time->format($treatment['Treatment']['created'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td><?php echo h($this->Time->format($treatment['Treatment']['modified'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td class="actions">
                                <?= $this->Html->link(
                                    '<i class="fa fa-eye m-r-5"></i>',
                                    array('action' => 'View', $treatment['Treatment']['id']),
                                    array('escape' => false)
                                ); ?>
                                <?= $this->Html->link(
                                    '<i class="fa fa-edit m-r-5"></i>',
                                    array('action' => 'Edit', $treatment['Treatment']['id']),
                                    array('escape' => false)
                                ); ?>
                                <?php echo $this->Form->postLink(
                                    '<i class="fa fa-trash-o m-r-5"></i>',
                                    array('action' => 'Delete', $treatment['Treatment']['id']),
                                    array('escape' => false),
                                    __('Are you sure you want to delete %s?', $treatment['Treatment']['name'])); ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                ...
                <div id="pagination" class="pull-right">
                    <?php
                    if ($this->params['paging']['Treatment']['pageCount'] > 1) {
                        ?>
                        <p>
                            <?php
