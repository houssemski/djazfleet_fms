...
$this->request->data['FuelCardAffectation']['start_date'] = $this->Time->format($this->request->data['FuelCardAffectation']['start_date'], '%d-%m-%Y');
$this->request->data['FuelCardAffectation']['end_date'] = $this->Time->format($this->request->data['FuelCardAffectation']['end_date'], '%d-%m-%Y');
?><h4 class="page-title"> <?=__('Edit affectation'); ?></h4>
    <div class="box">
