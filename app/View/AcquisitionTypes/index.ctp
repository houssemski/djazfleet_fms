<h4 class="page-title"> <?= __('Acquisition types'); ?></h4>
<div class="box-body">
    <div class="row">
        <!-- BASIC WIZARD -->
        <div class="col-lg-12">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("acquisitionTypes/deleteacquisitiontypes/");',
                                array(
                                    'escape' => false,
                                    'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5',
                                    'id' => 'delete',
                                ...
                                __('Are you sure you want to delete selected acquisition type ?')); ?>
            ...
            <div class="card-box p-b-0">
                ...
                <div id="impression">
                        ...
                        <div>
                            <label>
                                ...
                                <select name="slctlimit" id="slctlimit"
                                        onchange="slctlimitChanged('acquisitionTypes/index');">
                                    <option value="20" <?php
                                    if ($limit == 20) {
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tbody id="listeDiv">
                        <?php foreach ($acquisitionTypes as $acquisitionType): ?>
                            <tr id="row<?= $acquisitionType['AcquisitionType']['id'] ?>">
                                <td>


                                    <input id="idCheck" type="checkbox" class='id'
                                           value=<?php echo $acquisitionType['AcquisitionType']['id'] ?>>
                                </td>
                                <td><?php echo h($acquisitionType['AcquisitionType']['code']); ?>&nbsp;</td>
                                <td><?php echo h($acquisitionType['AcquisitionType']['name']); ?>&nbsp;</td>
                                <td><?php echo h($this->Time->format($acquisitionType['AcquisitionType']['created'],
                                        '%d-%m-%Y %H:%M')); ?>&nbsp;</td>
                                <td><?php echo h($this->Time->format($acquisitionType['AcquisitionType']['modified'],
                                        '%d-%m-%Y %H:%M')); ?>&nbsp;</td>
                                <td class="actions">
                                    <div class="btn-group ">
                                        ...
                                        <ul class="dropdown-menu" style="min-width: 70px;">
                                            ...
                                            <li>
                                                <?= $this->Html->link(
                                                    ...
                                                    array(
                                                        'action' => 'View',
                                                        $acquisitionType['AcquisitionType']['id']
                                                    ),
                    ...
                    <div id="pagination" class="pull-right">
                        <?php if ($this->params['paging']['AcquisitionType']['pageCount'] > 1) {
                            ?>
                            <p>
                                <?php
