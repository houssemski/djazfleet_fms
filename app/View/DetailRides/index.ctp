...
$this->end()
?><h4 class="page-title"> <?= __('Detail Rides'); ?></h4>
<div class="box-body">
        ...
        <div class="panel loop-panel">
            ...
            <div id="one" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <?php echo $this->Form->create('DetailRides', array(
                        'url' => array(
                            'action' => 'search'
                        ),
                        'novalidate' => true
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions actn">
                                ...
                                <ul class="dropdown-menu imp" role="menu">
                                    <li>
                                        <div class="timeline-body">
                                            <?php echo $this->Html->link(__('Download file model'), '/attachments/import_xls/detail_trajets.csv', array('class' => 'titre')); ?>
                                            <br/>

                                            <form id='DestinationImportForm' action='detailRides/import' method='post'
                                                  enctype='multipart/form-data' novalidate='novalidate'>
                                                <?php echo "<div class='form-group'>" . $this->Form->input('DetailRide.file_csv', array(
                                                        'label' => __('File .csv'),
                                                        'class' => '',
                                                        'type' => 'file',
                                                        //'id' =>'file_cars',
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("detailRides/deleteDetailRides/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected detail rides ?')); ?>
            ...
            <div class="card-box p-b-0">
                    ...
                    <div class="dataTables_length m-r-15" id="datatable-editable_length" style="display: inline-block;">
                        <label>&nbsp; <?= __('Order : ') ?>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="selectOrder"
                                    id="selectOrder" onchange="selectOrderChanged('detailRides/index','DESC');">
                                <option
                        ...
                        <span id="asc_desc" >
                        <i class="fa fa-sort-asc" id="asc" onclick="selectOrderChanged('detailRides/index', 'ASC');"></i>
                        <i class="fa fa-sort-desc" id="desc" onclick="selectOrderChanged('detailRides/index','DESC');"></i>
                        </span>
                    </div>
                    <div class="dataTables_length" id="datatable-editable_length" style="display: inline-block;">
                        <label>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="slctlimit"
                                    id="slctlimit" onchange="slctlimitChanged('detailRides/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('premium', __('Premium')); ?></th>

                        <th><?php echo $this->Paginator->sort('duration', __('Duration') . ' ' . __('theoretical')); ?></th>
                        <th><?php echo $this->Paginator->sort('duration', __('Duration') . ' ' . __('real')); ?></th>
                        ...
                        <tr id="row<?= $detailRide['DetailRide']['id'] ?>">
                            <td>
                                ...
                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $detailRide['DetailRide']['id'] ?>>
                            </td>
			    ...
			    <td><?php echo h($detailRide['DetailRide']['premium']); ?>&nbsp;</td>
