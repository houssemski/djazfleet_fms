...
?><h4 class="page-title"> <?=__('Edit detail ride'); ?></h4>
<div class="box">
        ...
        <div class="box-body">
            ...
            switch ($managementParameterMissionCost) {
                case '1':
                    ...
                    if(!empty($missionCosts)){
                        echo "<div class='form-group'>" . $this->Form->input('MissionCost.0.cost_day', array(
                                ...
                                'placeholder' => __('Enter cost'),
                                'class' => 'form-control',
                                'value' => $missionCosts[0]['MissionCost']['cost_day'],
                                'id' => 'cost_day'
                            )) . "</div>";
                ...
                case '2':
                    ...
                    if(!empty($missionCosts)){
                        echo "<div class='form-group'>" . $this->Form->input('MissionCost.0.cost_destination', array(
                                ...
                                'placeholder' => __('Enter cost'),
                                'class' => 'form-control',
                                'value' => $missionCosts[0]['MissionCost']['cost_destination'],
                                'id' => 'cost_destination'
                            )) . "</div>";
                    }else {
                        echo "<div class='form-group'>" . $this->Form->input('MissionCost.0.cost_destination', array(
                ...
                case '3':
                    ...
                    echo "<div class='form-group'>" . $this->Form->input('nb_costs', array(
                            'type' => 'hidden',
                            'value' =>$nbMissionCosts,
                            'id'=>'nb_costs',
                            'class' => 'form-control',
                        )) . "</div>";
                    ...
                    <?php } else {
                        ...
                        <table style="width: 83%;" id='dynamic_field'>
                            <tr>
                                <td>
                                    <?php  echo "<div class='form-group'>" . $this->Form->input('MissionCost.' . $i . '.ride_category_id', array(
                                            'label' => __('Ride category'),
            ...
            echo "<div class='form-group form-inline4' >" . $this->Form->input('duration_day', array(
                    'label' => __('Duration').' ('. __('Days') . ')',
                    'placeholder' => __('Day'),
                    'id' => 'duration_day',
                    'onchange'=>'calculateMissionCostByDurationDay();',
                    'class' => 'form-control',
                )) . "</div>";
            echo "<div class='form-group form-inline4'>" . $this->Form->input('duration_hour', array(
                    'label' =>__('Duration').' ('. __('Hour') . ')',
                    'placeholder' => __('Hour'),
                    'id' => 'duration_hour',
                    'class' => 'form-control',
                )) . "</div>";
            echo "<div class='form-group form-inline4'>" . $this->Form->input('duration_minute', array(
                    'label' =>__('Duration').' ('. __('Min') . ')',
                    'id' => 'duration_min',
                    'placeholder' => __('Min'),
                    'class' => 'form-control',
                )) . "</div>";?>
...
<script type="text/javascript">
    $(document).ready(function() {
        item=parseInt(jQuery('#nb_costs').val())-1;
          if (jQuery('#ride').val() > 0) {
                      ...
                      directionsService.route(request, function (response, status) {
                          if (status == google.maps.DirectionsStatus.OK) {
                              ...
                              // Display the duration:
                                if(jQuery('#duration_min').val()==0 && jQuery('#duration_hour').val()==0 && jQuery('#duration_day').val()==0) {
