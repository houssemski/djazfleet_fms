<h4 class="page-title"> <?= __('Zones'); ?></h4>
<div class="box-body">
    <div class="row">
        <!-- BASIC WIZARD -->
        <div class="col-lg-12">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("zones/deletezones/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected zone ?')); ?>
                        </div>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Zones', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <div class="bloc-limit btn-group pull-left">
                    <div>
                        <label>
                            ...
                            ?>
                            <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('zones/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('name', Configure::read("Cost")); ?></th>
                        <th><?php echo $this->Paginator->sort('rotation_number', __('Rotation number')); ?></th>
                    ...
                    <?php foreach ($zones as $zone): ?>
                        <tr id="row<?= $zone['Zone']['id'] ?>">
                            ...
                            <td><?php
                                ...
                                ?>&nbsp;</td>
                            <td><?php echo h($this->Time->format($zone['Zone']['created'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td><?php echo h($this->Time->format($zone['Zone']['modified'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td class="actions">
                                <div class="btn-group ">
                ...
                <div id="pagination" class="pull-right">
                    <?php if ($this->params['paging']['Zone']['pageCount'] > 1) { ?>
                        <p>
                            <?php
