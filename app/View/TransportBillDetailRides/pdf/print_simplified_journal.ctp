...
<div class="box-body">
    ...
    <table class='bon table-bordered tab_' >
        ...
        foreach ($transportBillDetailRides as $transportBillDetailRide){
            $totalAmount = $totalAmount +$transportBillDetailRide['TransportBillDetailedRides']['unit_price'] ;
            ?>
            <tr>
            <td><?php echo h($this->Time->format($transportBillDetailRide['TransportBillDetailedRides']['programming_date'], '%d-%m-%Y')); ?>&nbsp;</td>
            <td><?php echo h($transportBillDetailRide['Supplier']['code'].' : '.$transportBillDetailRide['Supplier']['name']); ?>&nbsp;</td>
                    <td><?= $transportBillDetailRide['Type']['name'] ?></td>
                <td><?php echo h($transportBillDetailRide['Subcontractor']['name']); ?>&nbsp;</td>
                <td><?php echo h($transportBillDetailRide['TransportBillDetailedRides']['designation']); ?>&nbsp;</td>
            <td><?php echo number_format($transportBillDetailRide['TransportBillDetailedRides']['unit_price'], 2, ",", $separatorAmount) ?>&nbsp;</td>
                <td><?php echo $transportBillDetailRide['TransportBillDetailedRides']['nb_trucks'] ?>&nbsp;</td>
       ...
       ?>
        <tr>
            <td colspan=8><?php echo __('Total')?></td>
