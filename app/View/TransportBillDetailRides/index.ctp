...
$this->end();
?><h4 class="page-title"> <?= __('Customer orders detail'); ?></h4>
<div class="box-body">
                ...
                <div>
                    <table id='datatable-responsive' class="table table-striped table-bordered dt-responsive nowrap "
                        ...
                        <tr>
                            ...
                            <?php if (Configure::read('utranx_trm') != '1'){ ?>
                        ...
                        if (!empty($transportBillDetailRides)) {
                            foreach ($transportBillDetailRides as $transportBillDetailRide) {
                                ...
                                <td><?= $transportBillDetailRide['TransportBillDetailedRides']['nb_trucks']
                                      ?></td>
                                        ...
                                        <ul class="dropdown-menu" style="min-width: 70px;">
                                            <li>
                                                <?= $this->Html->link(
                                                    ...
                                                    array('controller'=>'transportBills','action' => 'view',TransportBillTypesEnum::order, $transportBillDetailRide['TransportBill']['id']),
                                            ...
                                            <li  class='edit-link' title="<?= __('Delete') ?>">
                                                ...
                                                echo $this->Form->postLink(
                                                    ...
                                                    __('Are you sure you want to delete %s?', $transportBillDetailRide['TransportBillDetailRides']['reference'])); ?>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
