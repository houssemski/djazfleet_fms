...
echo $this->Html->image('/attachments/company/'.$dir.'/'. $array_fichier,  array('class' => 'picture_dir' ));
}else  { if ($ext=='pdf') {
...
<script type="text/javascript">     $(document).ready(function() {      });
 ...
 var dir1 = <?php echo json_encode($id_input); ?>
        ...
        jQuery("#"+''+dir+''+"").dialog('close');   //close containing dialog         
            ...
            jQuery("#"+''+dir1+''+"").load("<?php echo $this->Html->url('/customers/uploadPicture/')?>" +name+'/'+dir1);
       }
