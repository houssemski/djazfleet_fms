...
echo $this->Form->create('Affiliate' );
...
echo $this->Js->submit(__('Save'), array(  //create 'ajax' save button
    'update' => '#contentWrapAffiliate',  //id of DOM element to update with selector
    ...
    $url = '/customers/getAffiliates/'.$affiliate_id;
    echo "<script>
        jQuery('#dialogModalAffiliate').dialog('close');  //close containing dialog         
       jQuery('#affiliates').load('".$this->Html->url($url)."', function() {
