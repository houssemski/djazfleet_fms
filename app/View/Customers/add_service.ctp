...
echo $this->Js->submit(__('Save'), array(  //create 'ajax' save button
    ...
    $url = '/customers/getServices/'.$department_id.'/'.$service_id;
    echo "<script>
        jQuery('#dialogModalService').dialog('close');  //close containing dialog         
       jQuery('#services').load('".$this->Html->url($url)."', function() {
