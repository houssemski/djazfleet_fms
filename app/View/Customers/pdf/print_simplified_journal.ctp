...
<div class="box-body">
    ...
    <table class='bon table-bordered tab_' >
        ...
        <tr>
            ...
            <th ><strong><?php echo __('First name'); ?></strong></th>
            <th ><strong><?php echo  __('Last name'); ?></strong></th>
            <th><strong><?php echo  __('Group'); ?></strong></th>
            <th><strong><?php echo  __('Mobile'); ?></strong></th>
            <th><strong><?php echo  __('Email'); ?></strong></th>
        </tr>
        </thead>
        <tbody >
...
$this->dompdf->get_canvas()->page_text(400, 578, "Page: {PAGE_NUM} / {PAGE_COUNT}", null, 8, array(0,0,0));;
