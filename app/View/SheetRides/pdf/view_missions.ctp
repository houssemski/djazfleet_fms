...
<head>
    ...
    <style type="text/css">
        ...
        #header {left: 0; top: -120px; right: 0; height: 150px; border-bottom: 1px solid #000;}
        <?php } ?>
        @font-face {
            font-family: 'AlHurra';
...
<div class="box-body">
        ...
        <table class="table-body">
            ...
            <tr>
                <td style="padding-left: 250px">
                    ...
                    $consumptions = $consumptionArray[$sheetRide['SheetRide']['id']];
    ...
    <table style="margin-top: 30px">
        <tr >
            <td>
                <?php
                $audits = $auditArray[$sheetRide['SheetRide']['id']];
