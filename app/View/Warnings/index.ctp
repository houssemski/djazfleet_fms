<h4 class="page-title"> <?= __('Warnings'); ?></h4>
<div class="box-body">
    <div class="row">
        <!-- BASIC WIZARD -->
        <div class="col-lg-12">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("warnings/deleteWarnings/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected warnings ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Warnings', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <div class="bloc-limit btn-group pull-left">
                    <div>
                        <label>
                            ...
                            ?>
                            <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('warnings/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('customer_id', __('Employee')); ?></th>
                        ...
                        <tr id="row<?= $warning['Warning']['id'] ?>">
                            <td>
                                ...
                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $warning['Warning']['id'] ?>>
                            </td>
                            <td><?php echo h($warning['Warning']['code']); ?>&nbsp;</td>
                            <td><?php echo h($warning['Customer']['first_name'].'-'.$warning['Customer']['last_name']); ?>&nbsp;</td>
                                    ...
                                    <ul class="dropdown-menu" style="min-width: 70px;">
                                        ...
                                        <li>
                                            <?= $this->Html->link(
                                                ...
                                                array('action' => 'view', $warning['Warning']['id']),
                                        ...
                                        <li>
                                            <?= $this->Html->link(
                                                ...
                                                array('action' => 'Edit', $warning['Warning']['id']),
                                        ...
                                        <li>
                                            ...
                                            echo $this->Form->postLink(
                                                ...
                                                array('action' => 'delete', $warning['Warning']['id']),
                                                array('escape' => false, 'class' => 'btn btn-danger'),
                                                __('Are you sure you want to delete %s?', $warning['Warning']['code'])); ?>
                                        </li>
                                    </ul>
                                </div>
