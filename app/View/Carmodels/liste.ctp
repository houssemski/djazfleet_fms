<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
	...
	<tr id="row<?= $carmodel['Carmodel']['id'] ?>">
            <td>
                ...
                <input id="idCheck"type="checkbox" class = 'id' value=<?php echo $carmodel['Carmodel']['id'] ?> >
                </td>
                <td><?php echo h($carmodel['Carmodel']['code']); ?>&nbsp;</td>
		<td><?php echo h($carmodel['Carmodel']['name']); ?>&nbsp;</td>
                <td><?php echo h($carmodel['Mark']['name']); ?>&nbsp;</td>
		<td><?php echo h($this->Time->format($carmodel['Carmodel']['created'], '%d-%m-%Y %H:%M')); ?>&nbsp;</td>
		<td><?php echo h($this->Time->format($carmodel['Carmodel']['modified'], '%d-%m-%Y %H:%M')); ?>&nbsp;</td>
		<td class="actions">
            <div  class="btn-group ">
...
<div id ='pageCount' class="hidden">
                <?php
if($this->params['paging']['Carmodel']['pageCount'] > 1){
?>
<p>
	<?php
