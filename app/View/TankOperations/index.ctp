<h4 class="page-title"> <?= __('Tank operations'); ?></h4>
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("tanks/deleteTanks/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected tank operation ?')); ?>
                    ...
                    <div>
                        <label>
                            ...
                            <select name="slctlimit" id="slctlimit"
                                    onchange="slctlimitChanged('tankOperations/index');">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        jQuery("#dialogModalCapacity").dialog({
            autoOpen: false,
            height: 320,
            width: 400,
            show: {
        ...
        jQuery(".overlayCapacity").click(function (event) {
            event.preventDefault();
            jQuery('#contentWrapCapacity').load(jQuery(this).attr("href"));
            jQuery('#dialogModalCapacity').dialog('option', 'title', jQuery(this).attr("title"));
            jQuery('#dialogModalCapacity').dialog('open');
        });
