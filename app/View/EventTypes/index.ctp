<h4 class="page-title"> <?= __('Event Types'); ?></h4>
<div class="box-body">
    <div class="row">
        <!-- BASIC WIZARD -->
        <div class="col-lg-12">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("eventTypes/deleteeventtypes/");',
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('EventTypes', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <div class="bloc-limit btn-group pull-left">
                    <div>
                        <label>
                            ...
                            ?>
                            <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('eventTypes/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap custom-table"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('transact_type_id', __('Transaction')); ?></th>
                        <th><?php echo $this->Paginator->sort('with_date', __('With date')); ?></th>
                        <th><?php echo $this->Paginator->sort('with_km', __('With km')); ?></th>
                        ...
                        <tr id="row<?= $eventType['EventType']['id'] ?>">
                            <td>
                                ...
                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $eventType['EventType']['id'] ?>>
                            </td>
