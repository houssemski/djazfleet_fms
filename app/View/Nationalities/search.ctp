...
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("nationalities/deleteNationalities/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected country ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Nationalities', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                    ...
                    <div class="dataTables_length m-r-15" id="datatable-editable_length" style="display: inline-block;">
                        <label>&nbsp; <?= __('Order : ') ?>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="selectOrder"
                                    id="selectOrder" onchange="selectOrderChanged('nationalities/index');">
                                <option
                                        value="1" <?php if ($order == 1) echo 'selected="selected"' ?>> <?= __('abr') ?></option>
                                <option
                    ...
                    <div class="dataTables_length" id="datatable-editable_length" style="display: inline-block;">
                        <label>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="slctlimit"
                                    id="slctlimit" onchange="slctlimitChanged('nationalities/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <?php foreach ($nationalities as $nationality): ?>
                        <tr id="row<?= $nationality['Nationality']['id'] ?>">
                            <td>

                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $nationality['Nationality']['id'] ?>>
                            </td>
                                    ...
                                    <ul class="dropdown-menu" style="min-width: 70px;">
                                        ...
                                        <li>
                                            <?= $this->Html->link(
                                                ...
                                                array('action' => 'View', $nationality['Nationality']['id']),
                                        ...
                                        <li>
                                            <?= $this->Html->link(
                                                ...
                                                array('action' => 'Edit', $nationality['Nationality']['id']),
                                        ...
                                        <li>
                                            ...
                                            echo $this->Form->postLink(
                                                ...
                                                array('action' => 'delete', $nationality['Nationality']['id']),
                                                array('escape' => false, 'class' => 'btn btn-danger'),
                                                __('Are you sure you want to delete %s?', $nationality['Nationality']['name'])); ?>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div id="pagination" class="pull-right">
                    <?php
                    if ($this->params['paging']['Nationality']['pageCount'] > 1) {
                        ?>
                        <p>
                            <?php
