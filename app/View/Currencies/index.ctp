...
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("currencies/deleteCurrencies/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected currency ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Currencies', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                    ...
                    <div class="dataTables_length m-r-15" id="datatable-editable_length" style="display: inline-block;">
                        <label>&nbsp; <?= __('Order : ') ?>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="selectOrder"
                                    id="selectOrder" onchange="selectOrderChanged('currencies/index');">
                                <option
                    ...
                    <div class="dataTables_length" id="datatable-editable_length" style="display: inline-block;">
                        <label>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="slctlimit"
                                    id="slctlimit" onchange="slctlimitChanged('currencies/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('code', __('Abr')); ?></th>
                    ...
                    <?php foreach ($currencies as $currency): ?>
                        <tr id="row<?= $currency['Currency']['id'] ?>">
                            <td>

                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $currency['Currency']['id'] ?>>
                            </td>

                            <td><?php echo h($currency['Currency']['name']); ?>&nbsp;</td>
                            <td><?php echo h($currency['Currency']['abr']); ?>&nbsp;</td>
                                    ...
                                    <ul class="dropdown-menu" style="min-width: 70px;">
                                        ...
                                        <li>
                                            <?= $this->Html->link(
                                                ...
                                                array('action' => 'View', $currency['Currency']['id']),
                                        ...
                                        <li>
                                            <?= $this->Html->link(
                                                ...
                                                array('action' => 'Edit', $currency['Currency']['id']),
                                        ...
                                        <li>
                                            ...
                                            echo $this->Form->postLink(
                                                ...
                                                array('action' => 'delete', $currency['Currency']['id']),
                                                array('escape' => false, 'class' => 'btn btn-danger'),
                                                __('Are you sure you want to delete %s?', $currency['Currency']['name'])); ?>
                                        </li>
                                    </ul>
                                </div>
