...
?><h4 class="page-title"> <?=__('Edit marchandise'); ?></h4>
<div class="box">
...
<?php echo $this->Form->create('Marchandise'); ?>
        <div class="box-body">
            ...
            echo "<div class='form-group'>".$this->Form->input('wording', array(
                    ...
                    echo "<div class='form-group'>".$this->Form->input('weight_truck', array(
                    'label' => __('Weight').__(' / ')  .__('truck'),
                    'placeholder' =>__('Enter ').__('weight').__(' / ')  .__('truck'),
                    'class' => 'form-control',
                    ))."</div>";
