...
<div class="box-body">
    ...
    <div class="panel-group wrap" id="bs-collapse">
        <div class="panel loop-panel">
            <a class="fltr" data-toggle="collapse" data-parent="#" href="#one">
                ...
                <div class="row" style="clear:both">
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            <?= $this->Html->link('<i class="fa fa-money m-r-5"></i>' . __('Payment'),
            ...
            <div class="card-box p-b-0">
                    ...
                    <div class="dataTables_length m-r-15" id="datatable-editable_length" style="display: inline-block;">
                        <label>&nbsp; <?= __('Order : ') ?>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="selectOrder"
                                    id="selectOrder" onchange="selectOrderChanged('reservations/index');">
                                <option
                    ...
                    <div class="dataTables_length" id="datatable-editable_length" style="display: inline-block;">
                        <label>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="slctlimit"
                                    id="slctlimit" onchange="slctlimitChanged('marchandises/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('TransportBillDetailRides.unit_price', __('Price')); ?></th>
                        ...
                        <tr id="row<?= $reservation['Reservation']['id'] ?>">
                            <td>
                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $reservation['Reservation']['id'] ?>>
                            </td>
                            ...
                            <td>
                                <input  id ="supplier-<?php echo $reservation['Reservation']['id'] ?>"
                                        type="hidden" class='supplier-id'
                                        value=<?php echo $reservation['Supplier']['id'] ?>>
                            ...
                            <td class="right">
                                <?php if ($reservation['Reservation']['cost'] == 0) { ?>
                                    <div class="table-content editable">
                                        ...
                                        <input
                                                name="<?= $this->Reservation->encrypt("cost|" . $reservation['Reservation']['id']); ?>"
                                                placeholder="<?= __('Enter cost') ?>"
                                                value="<?= $reservation['Reservation']['cost'] ?>"
                            ...
                            <td><?php echo h(number_format($reservation['TransportBillDetailRides']['unit_price'], 2, ",", $separatorAmount)) ?></td>
...
<script type="text/javascript">
    ...
    function printSubcontractorState() {
        ...
        if(suppliers.length>1){
            alert("<?php echo __('Select one subcontractor, please.') ?>");
        } else {
            var myCheckboxes = new Array();
            jQuery('.id:checked').each(function () {
                myCheckboxes.push(jQuery(this).val());
            });
            var url = '<?php echo $this->Html->url(array('action' => 'printSubcontractorState', 'ext' => 'pdf'),
                array('target' => '_blank'))?>';
