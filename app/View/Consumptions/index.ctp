...
$this->end();
?>
<h4 class="page-title"> <?= __('Consumptions'); ?></h4>
<div class="box-body">
                        ...
                        if ($i < count($consumptions)) {
                            ...
                            if ($consumptions[$i]['Consumption']['id'] == $consumption['Consumption']['id']) {
                                ...
                                <tr id="row<?= $consumption['Consumption']['id'] ?>">
                                    ...
                                    <td><?php
                                        if (!empty($consumption['Customer']['first_name'])){
...
<script type="text/javascript">
    ...
    function printConsumptionState() {
        ...
        conditions[0] = jQuery('#consumption_date1').val();
        conditions[1] = jQuery('#consumption_date2').val();
        conditions[2] = jQuery('#car').val();
        conditions[3] = jQuery('#customer').val();
        conditions[4] = jQuery('#parc').val();
        conditions[5] = jQuery('#tank').val();
        conditions[6] = jQuery('#card').val();
        conditions[7] = jQuery('#compte').val();
        conditions[8] = jQuery('#coupons_from').val();
        conditions[9] = jQuery('#coupons_to').val();
        conditions[10] = jQuery('#type_consumption').val();
        ...
        var form = jQuery('<form action="' + url + '" method="post" target="_Blank" >' +
            '<input type="hidden" name="printConsumptionState" value="' + conditions + '" />' +
