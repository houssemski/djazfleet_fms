...
?>
    ...
    <head>
        ...
        <style type="text/css">
            ...
            #header { position: fixed; left: 0; top: -20px; right: 0; height: 30px; /*border-bottom: 1px solid #000;*/}
                ...
                <tr>
                    <?php switch ($typeConsumption) {
                        case ConsumptionTypesEnum::coupon : ?>
                            <th width="5%"><strong><?php echo __('N'); ?></strong></th>
                            <th width="10%"><strong><?php echo __('Date'); ?></strong></th>
                            <th width="5%"><strong><?php echo __('Nb coupons'); ?></strong></th>
                        ...
                        case ConsumptionTypesEnum::card : ?>
                            <th width="5%"><strong><?php echo __('N'); ?></strong></th>
                            <th width="10%"><strong><?php echo __('Date'); ?></strong></th>
                            <th width="5%"><strong><?php echo __('Cards'); ?></strong></th>
