                ...
                <div class="row" style="clear:both">
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?php } ?>
                            <?= $this->Html->link('<i class="fa fa-refresh m-r-5"></i><span>' . __('djazfleet') . '</span>', array('action' => 'importCarsPcApi'),
                    ...
                    <div class="bloc-limit btn-group pull-left">
                        <div>
                            <label>
                                ...
                                ?>
                                <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('cars/index');">
                        ...
                        <?php foreach ($cars as $car): ?>
                            <tr id="row<?= $car['Car']['id'] ?>">
                                ...
                                <td style="text-align: center">
                                    <?php
                                    if (!empty($car['CarType']['picture'])){
                                        $file_dir = WWW_ROOT . 'img/car_types/' . $car['CarType']['picture'];
                                        if(file_exists($file_dir)){
                                            echo $this->Html->image('/img/car_types/' . $car['CarType']['picture'],
                                                array(
                                                    'class' => 'car_type',
                                                    'alt' => 'carType'
                                                ));
                                ...
                                <td>
                                    ...
                                    echo '<span class="badge" style=background-color:' . $car['CarStatus']['color'];
                                    '';
                                    if($car['CarStatus']['id']==25){
                                        echo ";>" . h($car['CarStatus']['name']) .' </br>'.$this->Time->format($car['Car']['start_date'], '%d-%m-%Y').' - '.$this->Time->format($car['Car']['end_date'], '%d-%m-%Y') . "</span>";
                                    }else {
        ...
        <ul class="list-group m-b-0 user-list">
            ...
            foreach ($carStatuses as $carStatus) {
                ...
                foreach ($totals as $total) {
                    if ($carStatus == $total['CarStatus']['name']) {
            ...
            <div class='avatar text-center'>
                ...
                <div class='user-desc'>
                    <span class='name'><strong>" . $carStatus . "</strong> : 0 " . __('Car') . "</span>
                </div>
            </a>
        </li>";
                }
