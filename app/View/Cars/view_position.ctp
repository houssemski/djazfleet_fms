...
if(!empty($car)){
    $latlng='('.$car['Car']['latitude'].','.$car['Car']['longitude'].')';
}else {
    $latlng= null;
}
...
<div class="box">
    <div class="edit form card-box p-b-0" style="height: 780px;">
        ...
        <div class="box-body">
            ...
            $date = $this->Time->format($car['Car']['last_date_synchronization'], '%d-%m-%Y %H:%M');
            ...
            echo "<div class='form-group'>" . $this->Form->input('code', array(
                    'type' => 'hidden',
                    'value' => $car['Car']['code'].' - '.$car['CarModel']['name']."<br> Km : ".$car['Car']['km']."<br>".$car['Car']['place']."<br>".'Vitesse : '.$car['Car']['speed']."<br>".'Niveau carburant : '.$car['Car']['last_fuel_level']."<br>".'Poids : '.$car['Car']['weight']."<br>".'Date : '.$date,
                    'id'=>"code"
                )) . "</div>";
