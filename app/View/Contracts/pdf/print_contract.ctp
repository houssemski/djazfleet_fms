    ...
    <table class="main-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> <?= $contractCarType['CarType']['name']; ?></td>
                <td> <?php echo $contractCarType['ContractCarType']['cost']; echo ' '.__('per').' '; if($contractCarType['ContractCarType']['km_day'] ==1) echo __('Km') ; else echo __('Day');?></td>

                <td><?php echo h($this->Time->format($contract['Contract']['date_start'], '%d-%m-%Y')); ?>&nbsp;</td>
                <td><?php echo h($this->Time->format($contract['Contract']['date_end'], '%d-%m-%Y')); ?>&nbsp;</td>
            </tr>
        <?php } ?>
