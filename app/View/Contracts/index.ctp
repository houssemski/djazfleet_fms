<h4 class="page-title"> <?= __('Contracts'); ?></h4>
<div class="box-body">
    <div class="row">
        <!-- BASIC WIZARD -->
        <div class="col-lg-12">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("contracts/deleteContracts/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected contracts ?')); ?>
                        </div>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Contracts', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <div class="bloc-limit btn-group pull-left">
                    <div>
                        <label>
                            ...
                            ?>
                            <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('carTypes/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('supplier_id', __('Supplier')); ?></th>
                        <th><?php echo $this->Paginator->sort('detail_ride_id', __('Ride')); ?></th>
                        <th><?php echo $this->Paginator->sort('price_ht', __('Price HT')); ?></th>
                        <th><?php echo $this->Paginator->sort('price_return', __('Price return')); ?></th>
                        <th><?php echo $this->Paginator->sort('date_start', __('Start date')); ?></th>
                        <th><?php echo $this->Paginator->sort('date_end', __('End date')); ?></th>
                    ...
                    <?php foreach ($contracts as $contract): ?>
                        <tr id="row<?= $contract['ContractCarType']['id'] ?>">
                            ...
                            <td><?php echo h($contract['DepartureDestination']['name'] . '-' . $contract['ArrivalDestination']['name'] . '-' . $contract['CarType']['name']); ?>
                                &nbsp;</td>
                            <td><?php echo h(number_format($contract['ContractCarType']['price_ht'], 2, ",", ".")); ?>
                                &nbsp;</td>
                            <td><?php echo h(number_format($contract['ContractCarType']['price_return'], 2, ",", ".")); ?>
                                &nbsp;</td>
                            <td><?php echo h($this->Time->format($contract['ContractCarType']['date_start'], '%d-%m-%Y')); ?>
                                &nbsp;</td>
                            <td><?php echo h($this->Time->format($contract['ContractCarType']['date_end'], '%d-%m-%Y')); ?>
                                &nbsp;</td>
                            <td class="actions">
                                <div class="btn-group ">
                ...
                <div id="pagination" class="pull-right">
                    <?php if ($this->params['paging']['ContractCarType']['pageCount'] > 1) { ?>
                        <p>
                            <?php
