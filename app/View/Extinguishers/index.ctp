<h4 class="page-title"> <?= __('Extinguishers'); ?></h4>
<div class="box-body">
    <div class="row">
        <!-- BASIC WIZARD -->
        <div class="col-lg-12">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("extinguishers/deleteextinguishers/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected extinguishers ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Extinguishers', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <div class="bloc-limit btn-group pull-left">
                    <div>
                        <label>
                            ...
                            ?>
                            <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('extinguishers/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('extinguisher_number', __('Extinguisher number')); ?></th>
                        <th><?php echo $this->Paginator->sort('validity_day_date', __('Validity day date')); ?></th>
                        <th><?php echo $this->Paginator->sort('volume', __('Volume')); ?></th>
                        <th><?php echo $this->Paginator->sort('price', __('Amount')); ?></th>
                        <th><?php echo $this->Paginator->sort('Supplier.name', __('Supplier')); ?></th>
                        <th><?php echo $this->Paginator->sort('Location.name', __('Location')); ?></th>
                        ...
                        <tr id="row<?= $extinguisher['Extinguisher']['id'] ?>">
                            <td>
                                ...
                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $extinguisher['Extinguisher']['id'] ?>>
                            </td>
