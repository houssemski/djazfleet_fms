...
$this->request->data['Extinguisher']['validity_day_date'] = $this->Time->format($this->request->data['Extinguisher']['validity_day_date'], '%d-%m-%Y');
?><h4 class="page-title"> <?=__('Edit extinguisher');?></h4>
<?php
$this->start('css');
