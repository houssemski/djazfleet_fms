...
<head>
    ...
    <style type="text/css">
        ...
        <?php }else{ ?>
        @page { margin: 0px 0; }
        #header { left: 0; right: 0; height: 150px; /*border-bottom: 1px solid #000;*/}
        <?php } ?>
...
<div class="box-body">
    ...
    <table class='bon table-bordered tab_' >
        ...
        foreach ($bills as $bill){
            $totalAmountHt = $totalAmountHt +$bill['Bill']['total_ht'] ;
            $totalAmountTva = $totalAmountTva +$bill['Bill']['total_tva'] ;
...
<div class="box-body2">
    <div class="total">
        <span class="left"><strong><?php echo  __('Total HT: '); ?></strong></span> <span class="right"> <?= number_format($totalAmountHt, 2, ",", $separatorAmount).' '. $this->Session->read("currency");?></span><br>
        <span class="left"><strong><?php echo  __('Total TVA: '); ?></strong></span> <span class="right"> <?= number_format($totalAmountTva, 2, ",", $separatorAmount).' '. $this->Session->read("currency");?></span><br>
