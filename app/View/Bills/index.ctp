...
switch ($type) {
    case BillTypesEnum::supplier_order :
        ?><h4 class="page-title"> <?= __('Supplier orders'); ?></h4>
        <?php    break;
    case BillTypesEnum::receipt :
        ?><h4 class="page-title"> <?= __("Receipts"); ?></h4>
        <?php    break;
    case BillTypesEnum::return_supplier :
        ?><h4 class="page-title"> <?= __("Return supplier"); ?></h4>
        <?php    break;
    case BillTypesEnum::purchase_invoice :
        ?><h4 class="page-title"> <?= __("Purchase invoice"); ?></h4>
        <?php    break;
    case BillTypesEnum::credit_note :
        ?><h4 class="page-title"> <?= __("Credit note"); ?></h4>
        <?php    break;
    case BillTypesEnum::delivery_order :
        ?><h4 class="page-title"> <?= __("Delivery orders"); ?></h4>
        <?php    break;
    case BillTypesEnum::return_customer :
        ?><h4 class="page-title"> <?= __("Return customer"); ?></h4>
        <?php    break;
    case BillTypesEnum::entry_order :
        ?><h4 class="page-title"> <?= __("Entry order"); ?></h4>
        <?php    break;
    case BillTypesEnum::exit_order :
        ?><h4 class="page-title"> <?= __("Exit order"); ?></h4>
        <?php    break;
    case BillTypesEnum::renvoi_order :
        ?><h4 class="page-title"> <?= __("Renvoi order"); ?></h4>
        <?php    break;
    case BillTypesEnum::reintegration_order :
        ?><h4 class="page-title"> <?= __("Reintegration order"); ?></h4>
        <?php    break;
    case BillTypesEnum::commercial_bills_list :
        ?><h4 class="page-title"> <?= __("Commercial stock journal"); ?></h4>
        <?php    break;

    case BillTypesEnum::special_bills_list :
        ?><h4 class="page-title"> <?= __("Special stock journal"); ?></h4>
        <?php    break;

    case BillTypesEnum::purchase_invoices_list :
        ?><h4 class="page-title"> <?= __("Newspaper purchases"); ?></h4>
        <?php    break;    
	...
	case BillTypesEnum::sale_credit_note :
        ?><h4 class="page-title"> <?= __("Sale credit note"); ?></h4>
        <?php    break;
		
	case BillTypesEnum::sale_invoices_list :
        ?><h4 class="page-title"> <?= __("Newspaper sales"); ?></h4>
        <?php    break;

     case BillTypesEnum::product_request :
        ?><h4 class="page-title"> <?= __("Product requests"); ?></h4>
        <?php    break;
     ...
     case BillTypesEnum::purchase_request :
        ...
        ?><h4 class="page-title"> <?= __("Transfer receipts"); ?></h4>
        <?php    break;
    default :
...
<div class="box-body">
    ...
    <div class="panel-group wrap" id="bs-collapse">
		...
		<a class="collapsed fltr" data-toggle="collapse" data-parent="#" href="#one">
            ...
            <a  class="grp_actions_icon fltr" data-toggle="collapse" aria-expanded="true" data-parent="#" href="#grp_actions">
    ...
    <div class="row collapse in" id="grp_actions">
        <!-- BASIC WIZARD -->
        <div class="col-lg-12">
                ...
                <div class="row" style="clear:both">
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?php   if( $permissionTransformationSupplierOrder == 1){ ?>
                                       <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    ...
                                    <?= $this->Html->link(__('Sales invoice'), 'javascript:transformBills(4);',
                                        array('escape' => false, 'id' => 'facture', 'class' => 'btn btn-act ', 'disabled' => 'true')) ?>
                        ...
                        break;
									 ...
									 <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li>
                                                    ...
                                                    <?= $this->Html->link(__('Delivery order'), 'javascript:transformBills(6);',
                                                        array('escape' => false, 'id' => 'delivery', 'class' => 'btn btn-act ', 'disabled' => 'true')) ?>
                                ...
                                case BillTypesEnum::product_request :
                                    echo $this->Html->link('<i class="fa fa-plus m-r-5"></i>' . __('Add'),
                                        ...
                                        array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5'));
                                    ?>
                            <?php   if( $permissionTransformationProductRequest == 1){ ?>
                                   <div class="btn-group">
                                            <?= $this->Html->link('<i class="glyphicon glyphicon-export m-r-5"></i>' . __('Transform to'),
                                                'javascript:',
                                                array('escape' => false,
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <?= $this->Html->link(__('Purchase request'), 'javascript:transformBills(21);',
                                        array('escape' => false, 'id' => 'purchase-request', 'class' => 'btn', 'disabled' => 'true')) ?>
                               ...
                               <?php
                                   ...
                                   ?>
                                     ...
                                     <?php   if( $permissionTransformationPurchaseRequest == 1){ ?>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li>
                                                    <?= $this->Html->link(__('Supplier order'), 'javascript:transformBills(1);',
                                                        array('escape' => false, 'id' => 'commande', 'class' => 'btn btn-act ', 'disabled' => 'true')) ?>
                        ...
                        <?php    break;
                            ...
                            if($type == BillTypesEnum::purchase_request && $permissionValidationPurchaseRequest == 1){
                                echo $this->Html->link('<i class="glyphicon glyphicon-export m-r-5"></i>' . __('Validate'),
                                    'javascript:validateBills();',
                                    array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'validate', 'disabled' => 'true'));
                            }
                            if($type == BillTypesEnum::product_request && $permissionValidationProductRequest == 1){
                                echo $this->Html->link('<i class="glyphicon glyphicon-export m-r-5"></i>' . __('Validate'),
                                    'javascript:validateBills();',
                                    array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'validate', 'disabled' => 'true'));
                            }
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <?= $this->Html->link(__('Export All'), 'javascript:exportAllData("bills/export/all/'.$type.'");') ?>
                                    </li>
                                </ul>
					...
					<div class="dataTables_length m-r-15" id="datatable-editable_length" style="display: inline-block;">
                        <label>&nbsp; <?= __('Order : ') ?>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="selectOrder"
                                    id="selectOrder"
                                    onchange="selectOrderChanged('bills/index/<?php echo $type ?>','DESC');">
                                <option value=""></option>
								<option
                        ...
                        <span id="asc_desc" >
                        <i class="fa fa-sort-asc" id="asc" onclick="selectOrderChanged('bills/index/<?php echo $type ?>', 'ASC');"></i>
                        <i class="fa fa-sort-desc" id="desc" onclick="selectOrderChanged('bills/index/<?php echo $type ?>','DESC');"></i>
                        </span>
                    </div>
					<div class="dataTables_length" id="datatable-editable_length" style="display: inline-block;">
                        <label>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="slctlimit"
                                    id="slctlimit"
                                    onchange="slctlimitChanged('bills/index/<?php echo $type ?>');">
					...
					<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tr>
                            ...
                            <?php } ?>
                             <?php
                        if(
                        $type == BillTypesEnum::purchase_request || $type == BillTypesEnum::product_request){ ?>
                                            ...
                                            <td class="actions">
                                                <div class="btn-group ">
                                                    ...
                                                    <ul class="dropdown-menu" style="min-width: 70px;">
                                                        ...
                                                        <li class='edit-link' title="<?= __('Print bill with audit') ?>">
                                                            <?= $this->Html->link(
                                                                '<i class=" fa fa-print"></i>',
                                                                array('action' => 'viewBillWithAudit', 'ext' => 'pdf', $bill['Bill']['id']),
                                                                array('target' => '_blank', 'escape' => false, 'class' => 'btn btn-warning')
                                                            ); ?>
                                                        </li>
	   ...
	   function printSimplifiedJournalWithDetailBill() {
        ...
        function validateBills() {
            ...
            if(myCheckboxes.length>0) {
                var url = '<?php echo $this->Html->url('/bills/validateBills')?>';
