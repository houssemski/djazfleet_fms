        ...
        <tr id="row<?= $attachmentType['AttachmentType']['id'] ?>">
            <td>
                ...
                <input id="idCheck" type="checkbox" class='id'
                       value=<?php echo $attachmentType['AttachmentType']['id'] ?>>
            </td>

            <td><?php echo h($attachmentType['AttachmentType']['name']); ?>&nbsp;</td>
            <td><?php echo h($attachmentType['Rubric']['name']); ?>&nbsp;</td>

            <td><?php echo h($this->Time->format($attachmentType['AttachmentType']['created'], '%d-%m-%Y %H:%M')); ?>
                &nbsp;</td>
            <td><?php echo h($this->Time->format($attachmentType['AttachmentType']['modified'], '%d-%m-%Y %H:%M')); ?>
                &nbsp;</td>
            <td class="actions">
                <div class="btn-group ">
