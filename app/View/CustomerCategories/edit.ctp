<?php
?><h4 class="page-title"> <?= __('Edit') . " " . lcfirst(__('Category')) . " " . lcfirst(__("employee")); ?></h4>
<div class="box">
    <div class="edit form card-box p-b-0">
        <?php echo $this->Form->create('CustomerCategory', array('onsubmit' => 'javascript:disable();')); ?>
        <div class="box-body">
            <?php
            ...
            echo "<div class='form-group audiv1'>" . $this->Form->input('commercial', array(
               ...
               echo "<div class='form-group audiv1'>" . $this->Form->input('mechanician', array(
                       'label' => __('Mécanicien'),
                       'id' => 'mechanician',
                   )) . "</div>";
