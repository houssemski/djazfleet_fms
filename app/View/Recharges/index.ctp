<h4 class="page-title"> <?= __('Recharges'); ?></h4>
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("recharges/deleterecharges/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected recharges ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Recharges', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <div class="bloc-limit btn-group pull-left">
                    <div>
                        <label>
                            ...
                            ?>
                            <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('recharges/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('recharge_date', __('Recharge date')); ?></th>
                        ...
                        <tr id="row<?= $recharge['Recharge']['id'] ?>">
                            <td>
                                ...
                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $recharge['Recharge']['id'] ?>>
                            </td>
                            <td><?php echo h($recharge['Recharge']['code']); ?>&nbsp;</td>
                            <td><?php echo h($recharge['Extinguisher']['extinguisher_number']); ?>&nbsp;</td>
                            <td><?php echo $this->Time->format($recharge['Recharge']['recharge_date'], '%d-%m-%Y'); ?>
                                &nbsp;</td>
