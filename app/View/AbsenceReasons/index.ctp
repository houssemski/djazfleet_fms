...
<h4 class="page-title"> <?= __('Absence reasons'); ?></h4>
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("absenceReasons/deleteReasons/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                   'disabled' => 'true'),
                                __('Are you sure you want to delete selected reason ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('AbsenceReasons', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                    ...
                    <div class="dataTables_length m-r-15" id="datatable-editable_length" style="display: inline-block;">
                        <label>&nbsp; <?= __('Order : ') ?>
                            ...
                            <select aria-controls="datatable-editable" class="form-control input-sm" name="selectOrder"
                                    id="selectOrder" onchange="selectOrderChanged('absenceReasons/index');">
                                <option
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody id="listeDiv">
                    <?php foreach ($absenceReasons as $absenceReason): ?>
                        <tr id="row<?= $absenceReason['AbsenceReason']['id'] ?>">
                            <td>

                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $absenceReason['AbsenceReason']['id'] ?>>
                            </td>
                            <td><?php echo h($absenceReason['AbsenceReason']['code']); ?>&nbsp;</td>
                            <td><?php echo h($absenceReason['AbsenceReason']['name']); ?>&nbsp;</td>

                            <td><?php echo h($this->Time->format($absenceReason['AbsenceReason']['created'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td><?php echo h($this->Time->format($absenceReason['AbsenceReason']['modified'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td class="actions">
                                <div class="btn-group ">
                                    ...
                                    <ul class="dropdown-menu" style="min-width: 70px;">
                                        ...
                                        <li>
                                            <?= $this->Html->link(
                                                ...
                                                array('action' => 'View', $absenceReason['AbsenceReason']['id']),
                                        ...
                                        <li>
                                            <?= $this->Html->link(
                                                ...
                                                array('action' => 'Edit', $absenceReason['AbsenceReason']['id']),
                                        ...
                                        <li>
                                            ...
                                            echo $this->Form->postLink(
                                                ...
                                                array('action' => 'delete', $absenceReason['AbsenceReason']['id']),
                                                array('escape' => false, 'class' => 'btn btn-danger'),
                                                __('Are you sure you want to delete %s?', $absenceReason['AbsenceReason']['name'])); ?>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div id="pagination" class="pull-right">
                    <?php
                    if ($this->params['paging']['AbsenceReason']['pageCount'] > 1) {
                        ?>
                        <p>
                            <?php
