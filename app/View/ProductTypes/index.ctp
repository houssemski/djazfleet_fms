...
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("productTypes/deleteTypes/");',
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('ProductTypes', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <div class="bloc-limit btn-group pull-left">
                    <div>
                        <label>
                            ...
                            ?>
                            <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('productTypes/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <?php foreach ($productTypes as $productType): ?>
                        <tr id="row<?= $productType['ProductType']['id'] ?>">
                            <td>

                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $productType['ProductType']['id'] ?>>
                            </td>
                            <td><?php echo h($productType['ProductType']['name']); ?>&nbsp;</td>

                            <td><?php echo h($this->Time->format($productType['ProductType']['created'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td><?php echo h($this->Time->format($productType['ProductType']['modified'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td class="actions">
                                <div class="btn-group ">
                                    ...
                                    <ul class="dropdown-menu" style="min-width: 70px;">
                                        ...
                                        <li>
                                            ...
                                            echo $this->Form->postLink(
                                                ...
                                                __('Are you sure you want to delete %s?', $productType['ProductType']['name'])); ?>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div id="pagination" class="pull-right">
                    <?php
                    if ($this->params['paging']['ProductType']['pageCount'] > 1) {
                        ?>
                        <p>
                            <?php
