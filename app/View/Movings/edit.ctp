<?php
$this->request->data['Moving']['date_start'] = $this->Time->format($this->request->data['Moving']['date_start'], '%d-%m-%Y');
$this->request->data['Moving']['date_end'] = $this->Time->format($this->request->data['Moving']['date_end'], '%d-%m-%Y');
?><h4 class="page-title"> <?=__('Edit moving'); ?></h4>
<div class="box">
