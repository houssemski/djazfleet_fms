...
?><h4 class="page-title"> <?= __('Movings'); ?></h4>
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("movings/deletemovings/");',
                                array('escape' => false, 'class' => 'btn btn-inverse btn-bordred waves-effect waves-light m-b-5', 'id' => 'delete',
                                    'disabled' => 'true'),
                                __('Are you sure you want to delete selected movings ?')); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Movings', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <div class="bloc-limit btn-group pull-left">
                    <div>
                        <label>
                            ...
                            ?>
                            <select name="slctlimit" id="slctlimit" onchange="slctlimitChanged('movings/index');">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('Extinguisher.extinguisher_number', __('Extinguisher')); ?></th>
                        <th><?php echo $this->Paginator->sort('Carmodel.name', __('Car')); ?></th>
                        <th><?php echo $this->Paginator->sort('date_start', __('Date start')); ?></th>
                        <th><?php echo $this->Paginator->sort('date_end', __('Date end')); ?></th>
                        ...
                        <tr id="row<?= $moving['Moving']['id'] ?>">
                            <td>
                                ...
                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $moving['Moving']['id'] ?>>
                            </td>
                            ...
                            <td><?php echo $this->Time->format($moving['Moving']['date_start'], '%d-%m-%Y'); ?>
                                &nbsp;</td>
