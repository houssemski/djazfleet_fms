            ...
            <div class="card-box p-b-0">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('taken_over_date', __('Taken over date')); ?></th>
                            ...
                            <td class="actions">
                                <div class="btn-group ">
                                    ...
                                    <ul class="dropdown-menu" style="min-width: 70px;">
                                        ...
                                        <?php if ($permissionResponse == 1) { ?>
                                        <li>
                                            <?= $this->Html->link('<i class="fa fa-plus" title="' . __('Add response') . '"></i>',
                                                "javascript:addResponse(".$complaint['Complaint']['id'].");",
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        jQuery("#dialogModalResponses").dialog({
            autoOpen: false,
            height: 500,
            width: 450,
            show: {
    ...
    function addResponse(complaintId) {
            ...
            jQuery('#dialogModalResponses').dialog('option', 'title', "<?php echo __("Response") ?>");
            jQuery('#dialogModalResponses').dialog('open');
            jQuery('#dialogModalResponses').load('<?php echo $this->Html->url('/complaintResponses/addResponse/')?>' + complaintId );
