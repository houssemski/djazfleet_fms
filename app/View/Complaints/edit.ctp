...
<?php
$this->request->data['Complaint']['complaint_date'] = $this->Time->format($this->request->data['Complaint']['complaint_date'], '%d-%m-%Y');
?><h4 class="page-title"> <?=__('Edit complaint'); ?></h4>
    <div class="box">
        <div class="edit form card-box p-b-0">
            <?php echo $this->Form->create('Complaint' , array('onsubmit'=> 'javascript:disable();')); ?>
            <div class="box-body">
                <?php
                ...
                $date = date("Y-m-d");
                echo "<div class='form-group '>" . $this->Form->input('complaint_date', array(
                        'label' => '',
                ...
                echo "<div class='form-group'>".$this->Form->input('sheet_ride_detail_ride_id', array(
                        'label' => __('Missions'),
                        'options'=>$sheetRideDetailRides,
                        'class' => 'form-control select-search-mission',
                        'empty'=>'',
                    ))."</div>";
