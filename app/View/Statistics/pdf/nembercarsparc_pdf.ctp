<html>
    ...
    <body>
         <div id="header">
           <div class="title">Consommation monsuelle par parc</div>
        </div>
                        ...
                        if ($result['parcs'] == $key) {
                            ...
                            for ($i = 1; $i <= 12; $i++) {
                                ...
                                if (isset($result[$i]['month']) && $result[$i]['month'] == $i) {
                                    ...
                                    echo "<td class='td_tab'>" . number_format($result[$i]['nbCars'], 0, ",", ".") ."</td>";
                                    echo "<td class='td_tab'>" . number_format($result[$i]['sumKm'], 0, ",", ".") ."</td></tr>";
                                }
                            }
                        }
                    }
