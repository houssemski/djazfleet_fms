...
$this->end();
?><h4 class="page-title"> <?=__('Preinvoiced turnover per month'); ?></h4>
<div class="box-body">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-20">
                <?php echo $this->Form->create('Statistic', array(
                    'url'=> array(
                        'action' => 'preinvoicedTurnoverByMonth'
                    ),
                    'novalidate' => true
                )); ?>
...
color: #10c469 !important;font-weight:bold;'>"
                                    ...
                                    echo "<td class='right'>" . number_format($result[0]['sum_price'], 2, ",", ".") ."</td></tr>";
                                    $sumPriceMonth= $sumPriceMonth+$result[0]['sum_price'];
                                    $sumPrice= $sumPrice+$result[0]['sum_price'];
...
<script type="text/javascript">
    ...
    function exportDataPdf() {
        ...
        var url = '<?php echo $this->Html->url(array('action' => 'exportPreinvoicedTurnoverByMonthPdf', 'ext' => 'pdf'))?>';
