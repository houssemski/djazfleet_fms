<?php
?><h4 class="page-title"> <?=__('flotte ').__("Conductor"); ?></h4>
<div class="box-body">
    <div class="row">
    <!-- BASIC WIZARD -->
    <div class="col-lg-12">
    ...
    <div class="card-box p-b-20">
        ...
        <table class="table table-striped stats table-bordered" id='table_customer_flot'>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        jQuery("#enddate").inputmask("dd/mm/yyyy", {"placeholder": "dd/mm/yyyy"});
         ...
         function exportDataPdf() {
            var customer_flot = new Array();
            customer_flot[0] = jQuery('#car').val();
            customer_flot[1] = jQuery('#customer').val();
            customer_flot[2] = jQuery('#startdate').val();
            customer_flot[3] = jQuery('#enddate').val();
            customer_flot[4] = jQuery('#parc').val();

            var url = '<?php echo $this->Html->url(array('action' => 'customerflot_pdf', 'ext' => 'pdf'))?>';
            var form = jQuery('<form action="' + url + '" method="post" >' +
            '<input type="text" name="customerflot" value="' + customer_flot + '" />' +
            '</form>');
    ...
    $('#table_customer_flot').tableExport({
