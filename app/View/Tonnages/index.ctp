<h4 class="page-title"> <?= __('Tonnages'); ?></h4>
<?php
$this->start('css');
...
<div class="box-body">
                    ...
                    <div class="btn-group pull-left">
                        <div class="header_actions">
                            ...
                            <?= $this->Html->link('<i class="fa fa-trash-o m-r-5 m-r-5"></i>' . __('Delete'),
                                'javascript:submitDeleteForm("tonnages/deleteTonnages/");',
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Tonnages', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <?php foreach ($tonnages as $tonnage): ?>
                        <tr id="row<?= $tonnage['Tonnage']['id'] ?>">
                            <td>

                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $tonnage['Tonnage']['id'] ?>>
                            </td>

                            <td><?php echo h($tonnage['Tonnage']['code']); ?>&nbsp;</td>
                            <td><?php echo h($tonnage['Tonnage']['name']); ?>&nbsp;</td>
                            <td><?php echo h($this->Time->format($tonnage['Tonnage']['created'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td><?php echo h($this->Time->format($tonnage['Tonnage']['modified'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td class="actions">
                                <?= $this->Html->link(
                                    '<i class="fa fa-eye m-r-5"></i>',
                                    array('action' => 'View', $tonnage['Tonnage']['id']),
                                    array('escape' => false)
                                ); ?>
                                <?= $this->Html->link(
                                    '<i class="fa fa-edit m-r-5"></i>',
                                    array('action' => 'Edit', $tonnage['Tonnage']['id']),
                                    array('escape' => false)
                                ); ?>
                                <?php echo $this->Form->postLink(
                                    '<i class="fa fa-trash-o m-r-5"></i>',
                                    array('action' => 'Delete', $tonnage['Tonnage']['id']),
                                    array('escape' => false),
                                    __('Are you sure you want to delete %s?', $tonnage['Tonnage']['name'])); ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                ...
                <div id="pagination" class="pull-right">
                    <?php if ($this->params['paging']['Tonnage']['pageCount'] > 1) { ?>
                        <p>
                            <?php
