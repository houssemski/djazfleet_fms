...
<div class="box-body card-box p-b-10">
    <?php
    echo $this->Form->create('AccessPermission', array('onsubmit'=> 'javascript:disable();'));
	 ...
	 jQuery('#module').change(function () {
            ...
            jQuery('#sub_module_div').load('<?php echo $this->Html->url('/profiles/getSubModulesByModule/')?>' + jQuery(this).val(), function(){
				...
				jQuery('#sub_module').change(function () {
                    ...
                    jQuery("#div"+''+id+'').load('<?php echo $this->Html->url('/profiles/getSectionActionsBySubModule/')?>'+moduleId+'/' + jQuery(this).val(), function(){
                        jQuery('.select2').select2();
		...
		/*jQuery('#sub_module').change(function () {
            ...
            jQuery('#section_action_div').load('php echo $this->Html->url('/profiles/getSectionActionsBySubModule/')?>' + jQuery(this).val(), function(){
                jQuery('.select2').select2();
		...
		jQuery('#section').change(function () {
            ...
            jQuery('#section_action_div').load('<?php echo $this->Html->url('/profiles/getSectionActionsBySection/')?>' + jQuery(this).val(), function(){
                jQuery('.select2').select2();
                });
        });
