...
<div class="box-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card-box p-b-0">
                <?php echo $this->Form->create('Departments', array(
                    'url' => array(
                        'action' => 'search'
                    ),
                    'novalidate' => true,
                        ...
                        <tr id="row<?= $department['Department']['id'] ?>">
                            <td>
                                ...
                                <input id="idCheck" type="checkbox" class='id'
                                       value=<?php echo $department['Department']['id'] ?>>
                            </td>

                            <td><?php echo h($department['Department']['name']); ?>&nbsp;</td>
                            <td><?php echo h($this->Time->format($department['Department']['created'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td><?php echo h($this->Time->format($department['Department']['modified'], '%d-%m-%Y %H:%M')); ?>
                                &nbsp;</td>
                            <td class="actions">
                                <?= $this->Html->link(
