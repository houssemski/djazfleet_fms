...
class ClientController extends AppController {
	...
	public function request_index(){
		...
		$link =  "http://" . $_SERVER['HTTP_HOST'] . $this->webroot.'rest_messages.json';
	...
	public function request_view($id){
		...
		// remotely post the information to the server
		$link =  "http://" . $_SERVER['HTTP_HOST'] . $this->webroot.'rest_phones/view/'.$id.'.json';
	...
	public function request_edit($id){
		...
		// remotely post the information to the server
		$link =  "http://" . $_SERVER['HTTP_HOST'] . $this->webroot.'rest_messages/edit/'.$id.'.json';

		$data = null;
		$httpSocket = new HttpSocket();
		$data['Message']['status_id'] = 3;
	...
	public function request_add(){
		...
		// remotely post the information to the server
		$link =  "http://" . $_SERVER['HTTP_HOST'] . $this->webroot.'rest_phones/add.json';
